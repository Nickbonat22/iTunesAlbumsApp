...
extension ShowAlbumsViewController:  UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // add observer to the detailsVC
        NotificationCenter.default.addObserver(detailsVC.self, selector: #selector(detailsVC.updateUI(notification:)), name: .tappedCell, object: nil)
        
        // send notification with data
        NotificationCenter.default.post(name: .tappedCell, object: album)
        
        // push controller onto nav stack
